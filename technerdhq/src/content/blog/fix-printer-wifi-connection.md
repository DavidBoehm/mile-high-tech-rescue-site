...
**HP:** Settings → Network → WiFi Status
**Canon:** Setup → WiFi → Connection Status
**Epson:** Settings → Network Settings → WiFi Setup Wizard
**Brother:** Menu → Network → WLAN → Status
...
*TechNerdHQ helps Colorado homeowners solve tech headaches. For in-home help with printers, WiFi, smart home devices, and more, Mile High Tech Rescue serves Littleton and surrounding areas.*
